...
public class PDFUtils {
	...
	/**
     * M�thode fournissant l'affichage de l'exp�diteur
     * @param canvas
     */
    ...
    /**
     * Permet d'ajouter le bloc destinataire au PDF, cr�e une nouvelle ligne pour chaque String de la liste en param�tres/
     * @param data
     * @param canvas
     */
    ...
    public static void setOrderDetail(Order data, PdfContentByte canvas){
        ...
        //G�n�ration a partir du tableau : 
        i=i-30;
